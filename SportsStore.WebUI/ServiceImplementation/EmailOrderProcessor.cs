...
namespace SportsStore.WebUI.ServiceImplementation
{
    public class EmailSettings
    {
        ...
        public string Username = "[redacted]";
    ...
    public class EmailOrderProcessor : IOrderProcessor
    {
        ...
        public void ProcessOrder(CartView cart, ShippingDetailsView shippingDetails)
        {
